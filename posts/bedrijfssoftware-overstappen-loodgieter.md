...
## Wat je precies migreert (en wat je laat staan)

Een overstap voelt overweldigend omdat je denkt dat je alles moet meenemen. Dat hoeft niet. Splits je data in wat je echt nodig hebt en wat ballast is.

Deze gegevens neem je altijd mee:

- Je actieve klantbestand: naam, adres, telefoon, e-mail en het type installatie per klant.
- Openstaande offertes en lopende opdrachten.
- Onderhoudscontracten en cv-ketel onderhoud-cycli, zodat je terugkerende omzet niet stilvalt.
- Betaalgegevens en openstaande facturen van dit boekjaar.
...
Weet je niet zeker of jouw huidige systeem de zwakke schakel is, begin dan met een [gratis ai scan voor loodgieters](/gratis-scan). We kijken mee naar je administratie, planning en vindbaarheid, en laten zien wat een overstap je concreet oplevert. En omdat we in resultaat geloven, werken we met een Groei-of-Geld-Terug Garantie: levert het niet op wat we beloven, dan krijg je je geld terug.
