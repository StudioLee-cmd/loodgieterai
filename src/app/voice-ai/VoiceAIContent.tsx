        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="Voice AI telefonist voor loodgieters — automatische beantwoording van spoedoproepen"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Loodgieter werkt aan CV-ketel terwijl Voice AI binnenkomende oproep beantwoordt"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
            ...
            <p className="text-center text-sm text-foreground-accent mt-3 max-w-2xl mx-auto">
              Terwijl jij onder de wasmachine zit, neemt de AI elke oproep op — in jouw bedrijfsnaam, met jouw openingstijden.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Call-summary van Voice AI telefonist op smartphone naast pipe wrench"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">60% van loodgieter-oproepen komt buiten kantooruren binnen — `'`s avonds, weekend, na een lekkage om 23:00. Zonder Voice AI gaan die naar de concurrent. Met Voice AI plant de AI direct een afspraak (of triggert urgent doorschakelen bij echte spoed), stuurt een WhatsApp-samenvatting en plant in jouw agenda — zonder dat jij iets hoeft te doen.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/automatisering" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                ...
                <p className="text-foreground-accent text-sm mb-3">Herinneringen, klus-updates en review-verzoeken automatisch na elk gesprek.</p>
                <span className="inline-flex items-center gap-1 text-primary text-sm font-semibold">Bekijk <BsArrowRight size={14} /></span>
              </Link>
              <Link href="/crm" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors">CRM voor Loodgieters</h3>
