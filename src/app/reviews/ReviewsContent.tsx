...
const niche = 'loodgieter';
const nichePlural = 'loodgieters';
        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="5-sterren review op smartphone in dutch keuken — Google review na loodgieter klus"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Klant geeft 5-sterren review, loodgieter ontvangt notificatie naast bus"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
            ...
            <p className="text-center text-sm text-foreground-accent mt-3 max-w-2xl mx-auto">
              2 uur na afgerond werk vraagt het systeem automatisch om een Google review — meer 5-sterren, meer instroom uit lokale search.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="5-sterren reviews op smartphone in werkplaats setting"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">Voor loodgieters zijn Google reviews de allerbelangrijkste ranking-factor in lokale search. Een homeowner met lekkage tikt &quot;loodgieter in [stad]&quot; in en kiest in 87% van de gevallen voor het bedrijf met de meeste én hoogste sterren. Ons systeem stuurt automatisch een review-verzoek na elke klus — met directe link naar Google.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/review-pakket" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                ...
                <p className="text-foreground-accent text-sm mb-3">Combineer met fysieke NFC-kaartjes voor 5-sterren direct bij de bus of in de werkplaats.</p>
              ...
              <Link href="/seo" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors">SEO voor Loodgieters</h3>
