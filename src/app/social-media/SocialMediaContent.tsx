        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="Instagram feed voor loodgieter op smartphone — werkfotos en klant resultaten"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Content planner met ring-light setup op loodgieter werkbank"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
            ...
            <p className="text-center text-sm text-foreground-accent mt-3 max-w-2xl mx-auto">
              Wij plannen, ontwerpen en publiceren — jij focust op de klussen.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Instagram Reel voor loodgieter — voor-na werkresultaat"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">Voor loodgieters draait social om vertrouwen: nieuwe klanten ontdekken je via voor/na fotos van klussen, behind-the-scenes content uit je bus, en lokale resultaat-posts. Onze planner zorgt dat je consistent zichtbaar bent met content die klanten daadwerkelijk overtuigt — zonder dat jij uren per week kwijt bent.</p>
            </motion.div>
          </div>
