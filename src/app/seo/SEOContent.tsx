        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="SEO voor loodgieters — Google ranking dashboard op laptop"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Loodgieter bekijkt SEO ranking-chart op tablet in werkplaats"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
            ...
            <p className="text-center text-sm text-foreground-accent mt-3 max-w-2xl mx-auto">
              Maandelijks zie je hoe je positie groeit in lokale Google search en Google Maps voor jouw stad of regio.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Google Maps listing voor loodgieter bedrijf op smartphone"
                fill
                className="object-cover"
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Lokaal vindbaar als er een lekkage is — dat is het doel</h2>
              <p className="text-foreground-accent leading-relaxed">Voor loodgieters draait SEO om één moment: een homeowner heeft een lekkage en tikt &quot;loodgieter [stad]&quot; in. Wie staat bovenaan? Onze SEO automatisering optimaliseert je Google Bedrijfsprofiel, lokale citations en publiceert maandelijks SEO-blogs gericht op spoed-zoektermen en lokale &quot;loodgieter in [stad]&quot; varianten.</p>
            </motion.div>
          </div>
