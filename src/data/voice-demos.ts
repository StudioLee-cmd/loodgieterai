...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een klant met een lekkende leiding belt; de agent bepaalt of het spoed is en stuurt de loodgieter vandaag of morgen.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant wil de geplande cv-onderhoudsbeurt een week opschuiven.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand vraagt ’s avonds wat een nieuwe kraan plaatsen kost en of dat in één bezoek kan.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
