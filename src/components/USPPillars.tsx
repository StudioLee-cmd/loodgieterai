...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor loodgieters" }, { href: "/chatbot", anchor: "ai chatbot voor loodgieters" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor loodgieters" }, { href: "/reviews", anchor: "review management voor loodgieters" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor loodgieters" }, { href: "/crm", anchor: "crm voor loodgieters" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor loodgieters" }],
    }
];
