        ...
        <div id="credit-pricing" className="py-12 bg-gray-50/50 dark:bg-neutral-900/50 rounded-3xl border border-black/5 dark:border-white/10 mt-12 scroll-mt-20">
            <div className="text-center mb-10 px-5">
                ...
                <div className="mt-8 max-w-4xl mx-auto overflow-hidden rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-neutral-900 shadow-sm">
                    <div className="grid grid-cols-4 bg-gray-100/50 dark:bg-white/5 border-b border-black/5 dark:border-white/5 text-sm font-semibold p-4 text-foreground">
                    ...
                    <div className="grid grid-cols-4 p-4 border-b border-black/5 last:border-0 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-colors items-center bg-amber-100/50 dark:bg-amber-900/20 border-t border-amber-200/50 dark:border-amber-700/30">
                        ...
                        <div className="text-center text-gray-600 dark:text-gray-300">1000</div>
                        <div className="text-center text-amber-700/60 dark:text-amber-400/60 text-xs">€1.00</div>
                        <div className="text-right font-bold text-amber-600 dark:text-amber-400">€1000,-</div>
                    </div>
                </div>

                <p className="text-sm text-gray-600 dark:text-gray-400 text-center mt-4 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 px-5 max-w-6xl mx-auto">
                ...
                <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-green-200 dark:border-green-900 shadow-sm relative overflow-hidden">
                    ...
                    <div className="space-y-3">
                        {includedItems.map((item, index) => (
                            <div key={index} className="flex items-center gap-3 p-3 bg-green-50/50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-900/50">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-green-700 dark:text-green-500">{item.subtitle}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-blue-200 dark:border-blue-900 shadow-sm relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 bg-blue-500"></div>
                    <h4 className="text-xl font-bold text-blue-900 dark:text-blue-400 mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                        {paygItems.map((item, index) => (
                            <div key={index} className="flex items-center gap-3 p-3 bg-blue-50/50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-900/50">
